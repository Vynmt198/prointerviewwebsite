...
bookingsRouter.patch("/mentor/:id/start", authJwt, requireMentor, BookingsController.startMeetingForMentor);
...
bookingsRouter.patch("/:id/start", authJwt, BookingsController.startMeeting);
