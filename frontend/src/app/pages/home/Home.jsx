  ...
  return (
    ...
    >
      ...
      <section
        ...
        className="home-hero-video-section pointer-events-none relative z-20 -mt-[37.7rem] px-6 pb-12 sm:-mt-[12.7rem] sm:px-10 sm:pb-14 lg:-mt-[15.2rem] lg:px-16 lg:pb-16"
      >
